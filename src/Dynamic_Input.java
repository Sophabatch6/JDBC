...
public class Dynamic_Input {
    public static void main(String[] args) {
        ...
        try{
            Class.forName("com.mysql.cj.jdbc.Driver");// load driver to project
            Connection con = DriverManager.getConnection(dbURL,user,pass);// create a connection to database
